    ...
    const contentRequests = [
      // Slide 1 background
      {
        updatePageProperties: {
          objectId: slide1Id,
          pageProperties: { pageBackgroundFill: { solidFill: { color: { opaqueColor: { rgbColor: { red: 0.102, green: 0.102, blue: 0.18 } } } } } },
      ...
      { updateTextStyle: { objectId: "s1title", style: { foregroundColor: { opaqueColor: { rgbColor: { red: 0.96, green: 0.94, blue: 0.91 } } }, fontSize: { magnitude: 28, unit: "PT" }, bold: true }, fields: "foregroundColor,fontSize,bold" } },
      // Slide 1 subtitle
      ...
      { updateTextStyle: { objectId: "s1sub", style: { foregroundColor: { opaqueColor: { rgbColor: { red: 0.96, green: 0.94, blue: 0.91 } } }, fontSize: { magnitude: 18, unit: "PT" } }, fields: "foregroundColor,fontSize" } },
      ...
      { updateTextStyle: { objectId: "s2title", style: { foregroundColor: { opaqueColor: { rgbColor: { red: 0.96, green: 0.94, blue: 0.91 } } }, fontSize: { magnitude: 22, unit: "PT" }, bold: true }, fields: "foregroundColor,fontSize,bold" } },
      // Slide 2 results body — one textbox per candidate
      ...candidateCounts.map((c: any, i: number) => [
        { createShape: { objectId: `s2c${i}`, shapeType: "TEXT_BOX", elementProperties: { pageObjectId: "slide2", size: { width: { magnitude: 580, unit: "PT" }, height: { magnitude: 40, unit: "PT" } }, transform: { scaleX: 1, scaleY: 1, translateX: 50, translateY: 120 + i * 50, unit: "PT" } } } },
        { insertText: { objectId: `s2c${i}`, insertionIndex: 0, text: `${c.name}  |  ${c.party}  |  ${c.votes} votes` } },
        { updateTextStyle: { objectId: `s2c${i}`, style: { foregroundColor: { opaqueColor: { rgbColor: { red: 0.96, green: 0.94, blue: 0.91 } } }, fontSize: { magnitude: 16, unit: "PT" } }, fields: "foregroundColor,fontSize" } },
      ]).flat(),
      // Slide 3 winner
      ...
      { updateTextStyle: { objectId: "s3label", style: { foregroundColor: { opaqueColor: { rgbColor: { red: 0.83, green: 0.64, blue: 0.1 } } }, fontSize: { magnitude: 20, unit: "PT" }, bold: true }, fields: "foregroundColor,fontSize,bold" } },
      ...
      { updateTextStyle: { objectId: "s3winner", style: { foregroundColor: { opaqueColor: { rgbColor: { red: 0.96, green: 0.94, blue: 0.91 } } }, fontSize: { magnitude: 36, unit: "PT" }, bold: true }, fields: "foregroundColor,fontSize,bold" } },
      ...
      { updateTextStyle: { objectId: "s4cert", style: { foregroundColor: { opaqueColor: { rgbColor: { red: 0.96, green: 0.94, blue: 0.91 } } }, fontSize: { magnitude: 18, unit: "PT" } }, fields: "foregroundColor,fontSize" } },
    ];
